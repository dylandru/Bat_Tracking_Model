...
def process_video(input_path, output_path):
    model = YOLO('/Users/dylandrummey/Downloads/DylanDru_GitHub/Bat_Tracking_Model/Bat_Tracking_Model/bat_model_weights/bat_tracking.pt')  # Update the path to your model weights
